...
#---Plots-----------------------------------------------------------
  mod_08_plots_server("plots", geneInfoLookup, geneInfoLookup_background, converted_background, go_button = reactive(input$goButton), select_org = reactive(input$selectOrg), ggplot2_theme = reactive(input$ggplot2_theme))
